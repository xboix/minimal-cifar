...
def get_statistics(all_nets, multi, SMALL):
    ...
    for idx_net, nets in enumerate(all_nets):
        if SMALL == '':
            ...
            tmp = np.load(PATH_TO_DATA + '/tmp_results_' + multi + nets + '_' + SMALL + '.npy')
...
for SMALL in ['small', '']:
    for STRICT, strict_name in enumerate(['strict', 'loose']):
        for kk in ['', 'multi']:
            ...
            mm, ss = get_statistics(all_nets, kk, SMALL)
            ...
            pyplot.xticks(crops, ['28', '24', '20', '16', '12'])
            ...
            pyplot.savefig('./plots/amount_'+strict_name+'/shift_augmentation' + kk + SMALL +'.pdf', dpi=1000)
            ...
            pyplot.savefig('./plots/amount_'+strict_name+'/shift_regularizers' + kk + SMALL +'.pdf', dpi=1000)
            ...
            pyplot.savefig('./plots/amount_'+strict_name+'/shift_pooling' + kk + SMALL +'.pdf', dpi=1000)
